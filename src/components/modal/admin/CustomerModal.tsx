...
import { FormDropdown, FormInput, FormInputArea } from '../../custom/AppInput';
...
const CustomerModal = ({ isOpen, handleClose, state, setState, handleSubmit }: Props) => {
    ...
    return (
        <Modal isOpen={isOpen} handleClose={handleClose}>
            <div className='max-h-full w-[70%] bg-white rounded-md shadow-sm pt-5 px-6'>
                <div className='w-full flex items-center justify-between border-b border-b-gray-200 pb-3'>
                    <div className='font-semibold text-lg'>Add New Customer</div>
                ...
                <div className='flex gap-5'>
                    ...
                    <div className='w-full pt-4 pb-24 pr-2'>
                        <FormInput label='Name' placeholder='Enter name' name='name' value={state?.name} onChange={handleChange} />
                        <FormDropdown
                            data={genderList}
                            label='Gender'
                            placeholder='Select'
                        ...
                        />
                        <FormInput label='Phone' placeholder='Enter phone' name='phone' value={state?.phone} onChange={handleChange} />
                        <FormInputArea label='Address' placeholder='Enter address' name='address' value={state?.address} onChange={handleChange} />
                        <FormDropdown
                            label='Status'
                            name='status'
                            placeholder='Select'
