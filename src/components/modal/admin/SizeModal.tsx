...
const SizeModal = ({ isOpen, handleClose, state, handleChange }: Props) => {
    return (
        <Modal isOpen={isOpen} handleClose={handleClose}>
            <div className='max-h-full bg-white rounded-md shadow-sm pt-5 px-6'>
                <div className='w-full flex items-center justify-between border-b border-b-gray-200 pb-3'>
                    <div className='font-semibold text-lg'>Add New Size</div>
                ...
                <div className='w-[500px] flex gap-3'>
                    <div className='w-full pt-4 pb-6 pr-2'>
                        <FormInput label='Size Name' placeholder='Type here' name='name' value={state?.name} onChange={handleChange} />
                        <FormDropdown
                            label='Status'
                            name='status'
                            placeholder='Select'
